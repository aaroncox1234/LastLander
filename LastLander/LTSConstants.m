...
const float RED_SHIP_SPAWN_INTERVAL_MIN = 1.0f;
const float RED_SHIP_SPAWN_INTERVAL_MAX = 6.0f;

const float RED_SHIP_SPEED_MIN = 40.0f;
const float RED_SHIP_SPEED_MAX = 60.0f;

const float PLAYER_SHIP_SPEED_MIN = 60.0;
const float PLAYER_SHIP_SPEED_MAX = 120.0;
const float PLAYER_SHIP_SPEED_BOOST_RATE = 20.0f;
const float PLAYER_SHIP_TURN_RATE_DEGREES = 90.0f;

const float LANDING_SPEED_MAX = PLAYER_SHIP_SPEED_MIN + 5.0f; 
const float LANDING_ANGLE_MIN = 0.0f;
const float LANDING_ANGLE_MAX = 25.0f;

const float LANDING_DECELERATION = 45.0f;
const float LANDING_SETTLE_ROTATION_ACCELERATION = -45.0f;
...
const float WORLD_BOUNDS_SCREEN_BUFFER = 100.0f;